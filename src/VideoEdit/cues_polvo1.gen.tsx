...
export const CUES: Cue[] = [
  ...
  { key: "p1_03", start: 17.3, dur: 3.34, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_fila_hormigas.mp4" hue="cold" kicker="Hormigas como en su casa" /> },
  { key: "p1_04", start: 20.64, dur: 7.06, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/pimientos_mordidos.png" hue="cold" kicker="Arruinados en una noche" /> },
  { key: "p1_05", start: 27.7, dur: 10.62, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_rociar_insecticida.mp4" hue="amber" kicker="Compraste el insecticida" /> },
  ...
  { key: "p1_12", start: 105.34, dur: 11.22, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/polvo_textura.png" hue="blue" kicker="Suave como talco" /> },
  ...
  { key: "p1_20", start: 224.7, dur: 10.64, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_babosa_hoja.mp4" hue="amber" kicker="Babosas que comen de noche" /> },
  ...
  { key: "p1_24", start: 282.3, dur: 6.82, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/espolvorear_seco.png" hue="amber" kicker="Regla 1: siempre en seco" /> },
  ...
  { key: "p1_26", start: 305.24, dur: 16.88, kind: "annotated", el: (d) => <AnnotatedImage durationInFrames={d} image="img/anillo_polvo.png" annotations={[{"kind":"circle","x":0.5,"y":0.7,"w":0.45,"h":0.3,"label":"Anillo alrededor del tallo","color":"good"},{"kind":"arrow","x":0.5,"y":0.4,"fromX":0.18,"fromY":0.2,"label":"Capa fina, como nevadita"}]} eyebrow="Regla 2: capa fina + anillo" caption="Un anillo en la base = muralla de vidrio" hue="amber" /> },
  ...
  { key: "p1_29", start: 337.1, dur: 19.12, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_huerta_atardecer.mp4" hue="amber" kicker="Al atardecer, sin abejas" /> },
  { key: "p1_30", start: 356.22, dur: 5.64, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/pañuelo_cara.png" hue="amber" kicker="Regla 4: pañuelo y sin viento" /> },
  { key: "p1_31", start: 361.86, dur: 12.34, kind: "callout", el: (d) => <CalloutMark durationInFrames={d} figure="★" image="img/bolsa_grado_alim.png" eyebrow="Al comprar" caption="Pedí el de GRADO ALIMENTICIO (no el de piletas)" accent="good" hue="amber" /> },
