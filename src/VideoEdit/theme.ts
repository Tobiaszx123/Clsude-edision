...
// ★ Cargar SOLO normal + pesos usados + latino. Sin esto, loadFont() baja TODAS
// las variantes (itálicas × 5 pesos × 7 alfabetos) → en el RENDER los fetch de
// fuentes hacen timeout de delayRender y EL RENDER FALLA. (Inline, sin `as const`.)
export const { fontFamily: SERIF } = loadFont("normal", {
