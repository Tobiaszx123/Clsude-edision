...
// Cargar SOLO los pesos que usa el proyecto (300–800) y el alfabeto latino.
// Sin esto, loadFont() baja todas las variantes/alfabetos (~126 pedidos por fuente),
// lo que genera warnings/errores en el Studio y lo hace cargar lento.
// (Opciones inline, sin `as const`, para que TS las tipe contra el parámetro.)
const { fontFamily: INTER } = loadInter("normal", {
  weights: ["300", "400", "500", "600", "700", "800"],
  subsets: ["latin"],
  ignoreTooManyRequestsWarning: true,
});
const { fontFamily: MONT } = loadMont("normal", {
  weights: ["300", "400", "500", "600", "700", "800"],
  subsets: ["latin"],
  ignoreTooManyRequestsWarning: true,
});
