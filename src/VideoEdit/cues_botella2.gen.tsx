...
export const CUES: Cue[] = [
  ...
  { key: "b2_33", start: 258.82, dur: 2.2, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/abuelo_huerta2.png" eyebrow="Y mirá cómo dejan de sufrir" words={parseQuote("Así lo hacían *los de antes*.")} accent="amber" hue="amber" fontSize={88} /> },
];
