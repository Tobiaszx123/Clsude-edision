...
export const CUES: Cue[] = [
  ...
  { key: "b2_04", start: 17, dur: 6.18, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_valija_viaje.mp4" hue="blue" kicker="Te vas tranquilo" /> },
  { key: "b2_05", start: 23.18, dur: 2.2, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/huerta_verde_botella.png" eyebrow="Volvés y..." words={parseQuote("Tus plantas siguen *verdes*, esperándote.")} accent="good" hue="amber" fontSize={82} /> },
  { key: "b2_06", start: 25.04, dur: 8.02, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/raices_hondas_robustas.png" hue="amber" kicker="Raíces hondas y robustas" /> },
  ...
  { key: "b2_08", start: 35.98, dur: 4.26, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/hojas_sanas.png" hue="amber" kicker="Plantas más sanas" /> },
  ...
  { key: "b2_10", start: 53.34, dur: 6.26, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/botella_goteo.png" eyebrow="Ahorro de agua" words={parseQuote("Cada gota va a la raíz. En sequía, esto es *oro*.")} accent="amber" hue="amber" fontSize={78} /> },
  ...
  { key: "b2_12", start: 64.18, dur: 7.1, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/abono_liquido.png" hue="amber" kicker="También alimenta" /> },
  { key: "b2_13", start: 71.28, dur: 9.36, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/compost_puñado.png" hue="amber" kicker="Agua de compost o estiércol" /> },
  { key: "b2_14", start: 80.64, dur: 5.66, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/dg_riega_alimenta.png" eyebrow="El primer secreto" words={parseQuote("Riego y *comida* en el mismo gesto.")} accent="good" hue="amber" fontSize={84} /> },
  { key: "b2_15", start: 86.3, dur: 5.66, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/tomate_cargado.png" hue="amber" kicker="Plantas grandes: botella grande" /> },
  ...
  { key: "b2_17", start: 95.18, dur: 5.24, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_maceta_balcon.mp4" hue="blue" kicker="Las macetas son las que más sufren" /> },
  ...
  { key: "b2_19", start: 112.34, dur: 5.38, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/trapo_botella.png" hue="amber" kicker="Zona seca: envolvela en un trapo" /> },
  { key: "b2_20", start: 117.72, dur: 27.44, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/trapo_botella.png" eyebrow="El tercer secreto" words={parseQuote("Sale más *lento* y dura más.")} accent="amber" hue="amber" fontSize={84} /> },
  ...
  { key: "b2_22", start: 152.9, dur: 4.94, kind: "impact", el: (d) => <ImpactReveal durationInFrames={d} image="img/huerta_verde_botella.png" impact="NO hay plata en lo gratis" setup="La respuesta de siempre:" impactAccent="danger" hitAt={2.5} boom={2} /> },
  ...
  { key: "b2_24", start: 164.06, dur: 10.78, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_tienda_jardineria.mp4" hue="red" kicker="Todo lo que te venden" /> },
  ...
  { key: "b2_26", start: 182.74, dur: 4.06, kind: "chips", el: (d) => <ChipsCluster durationInFrames={d} bg="image" image="img/huerta_verde_botella.png" title="Una familia que sabe..." chips={["riega con basura","y compra menos de todo"]} hue="amber" /> },
  ...
  { key: "b2_28", start: 197.72, dur: 3.76, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/abuelo_huerta.png" hue="amber" kicker="Vos podés ser el que recuerda" /> },
  ...
  { key: "b2_30", start: 210.86, dur: 24.26, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/huerta_verde_botella.png" eyebrow="Te apuesto" words={parseQuote("La vas a ver *mejor que nunca*.")} accent="good" hue="amber" fontSize={84} /> },
  { key: "b2_31", start: 235.12, dur: 17.16, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/tierra_negra.png" hue="amber" kicker="La próxima: tierra negra y rica" /> },
  { key: "b2_32", start: 252.28, dur: 6.54, kind: "impact", el: (d) => <ImpactReveal durationInFrames={d} image="img/botella_enterrada.png" impact="Despacio y profundo" setup="No tires esa botella. Enterrala." impactAccent="good" hitAt={2.5} boom={1} /> },
  { key: "b2_33", start: 258.82, dur: 2.2, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/abuelo_huerta.png" eyebrow="Y mirá cómo dejan de sufrir" words={parseQuote("Así lo hacían *los de antes*.")} accent="amber" hue="amber" fontSize={88} /> },
];
