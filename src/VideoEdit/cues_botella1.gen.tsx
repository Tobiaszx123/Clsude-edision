...
export const CUES: Cue[] = [
  ...
  { key: "b1_02", start: 9.4, dur: 5.56, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_planta_marchita.mp4" hue="cold" kicker="Hojas mustias, colgando" zoom={[1.05,1.18]} /> },
  { key: "b1_03", start: 14.96, dur: 3.6, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_tomate_marchito.mp4" hue="cold" kicker="Doblado sobre sí mismo" zoom={[1.04,1.16]} /> },
  ...
  { key: "b1_05", start: 25.88, dur: 8.22, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_regar_regadera.mp4" hue="amber" kicker="Regaste todos los días" zoom={[1.18,1.05]} /> },
  ...
  { key: "b1_10b", start: 60.56, dur: 6.1, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_botellas_basura.mp4" hue="blue" kicker="Con lo que tirás a la basura" zoom={[1.06,1.16]} /> },
  ...
  { key: "b1_12", start: 94.04, dur: 5.04, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_regar_manguera.mp4" hue="amber" kicker="Mojás la tierra por arriba" zoom={[1.16,1.06]} /> },
  ...
  { key: "b1_16b", start: 121.78, dur: 9.04, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_raices_maceta.mp4" hue="amber" kicker="Raíces que suben, no bajan" zoom={[1.04,1.14]} /> },
  ...
  { key: "b1_17", start: 147.66, dur: 2.2, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_planta_seca_maceta.mp4" hue="cold" kicker="El día que faltás, se muere" zoom={[1.05,1.18]} /> },
  ...
  { key: "b1_16d", start: 157.76, dur: 8.66, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/raices_hondas_real.png" hue="amber" kicker="Raíces hondas, fuertes" zoom={[1.18,1.05]} /> },
  ...
  { key: "b1_21", start: 186.58, dur: 3.06, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_olla_barro.mp4" hue="blue" kicker="Hace miles de años" zoom={[1.04,1.15]} /> },
  ...
  { key: "b1_31", start: 294.56, dur: 3.1, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/el_entierra_botella.png" hue="amber" kicker="Cavás al lado, a un palmo" zoom={[1.16,1.06]} /> },
  { key: "b1_el_cava", start: 297.66, dur: 6.36, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/el_cava_pozo.png" hue="amber" kicker="Cavo al lado, a un palmo" zoom={[1.06,1.16]} /> },
  ...
  { key: "b1_34", start: 341.74, dur: 9.82, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/botella_tapa_agujero.png" hue="amber" kicker="Un agujerito de nada en la tapa" zoom={[1.04,1.14]} /> },
  { key: "b1_35", start: 351.56, dur: 3.42, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/el_llena_botella.png" hue="amber" kicker="Llenala y listo" zoom={[1.05,1.18]} /> },
