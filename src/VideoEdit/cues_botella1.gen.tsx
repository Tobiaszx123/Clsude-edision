...
export const CUES: Cue[] = [
  ...
  { key: "b1_16b", start: 121.78, dur: 9.04, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/raices_flojas_maceta.png" hue="amber" kicker="Raíces que suben, no bajan" zoom={[1.04,1.14]} /> },
