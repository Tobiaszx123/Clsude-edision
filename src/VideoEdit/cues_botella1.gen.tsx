...
export const CUES: Cue[] = [
  ...
  { key: "b1_04", start: 18.56, dur: 7.32, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/tomate_doblado.png" eyebrow="Y duele" words={parseQuote("Bastó un *fin de semana* de calor.")} accent="danger" hue="red" fontSize={88} /> },
  ...
  { key: "b1_06", start: 34.1, dur: 5.02, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/plantas_caidas.png" eyebrow="Y aún así..." words={parseQuote("Se *marchitó*. ¿Y no entendés por qué?")} accent="danger" hue="cold" fontSize={84} /> },
  ...
  { key: "b1_10", start: 58.1, dur: 2.46, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/botella_plastica.png" eyebrow="Sabiduría vieja" words={parseQuote("El truco más *viejo* de la tierra, en una botella.")} accent="good" hue="amber" fontSize={80} /> },
  ...
  { key: "b1_10c", start: 66.66, dur: 17.68, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/huerta_seca.png" eyebrow="Por qué nadie te lo cuenta" words={parseQuote("No hay *ganancia* en que riegues gratis con la basura.")} accent="danger" hue="amber" fontSize={74} /> },
  ...
  { key: "b1_16b", start: 121.78, dur: 9.04, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/raices_cortas.png" hue="amber" kicker="Raíces que suben, no bajan" /> },
  { key: "b1_16c", start: 130.82, dur: 16.84, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/plantas_caidas.png" eyebrow="Una planta que depende de vos" words={parseQuote("El día que faltás... *se muere*.")} accent="danger" hue="cold" fontSize={80} /> },
  ...
  { key: "b1_19b", start: 166.42, dur: 8.32, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/raices_hondas_real.png" eyebrow="Su propia despensa" words={parseQuote("Tiene su *despensa* de agua allá abajo.")} accent="good" hue="amber" fontSize={78} /> },
  { key: "b1_20", start: 174.74, dur: 11.84, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/raices_hondas_real.png" eyebrow="Toda la diferencia" words={parseQuote("No es *cuánta* agua. Es a qué *profundidad*.")} accent="good" hue="amber" fontSize={78} /> },
  ...
  { key: "b1_23", start: 211.64, dur: 14.96, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/olla_barro_enterrada.png" eyebrow="El truco de hoy" words={parseQuote("La botella es esa *olla de barro*, hecha con lo que ibas a tirar.")} accent="good" hue="blue" fontSize={72} /> },
  ...
  { key: "b1_28", start: 259.02, dur: 8.88, kind: "callout", el: (d) => <CalloutMark durationInFrames={d} figure="6-8" image="img/botella_agujeros.png" eyebrow="Cantidad justa" caption="agujeritos chicos, repartidos abajo" accent="good" hue="amber" /> },
  ...
  { key: "b1_36", start: 354.98, dur: 6.06, kind: "impact", el: (d) => <ImpactReveal durationInFrames={d} image="img/botella_goteo.png" impact="CERO desperdicio" setup="El agua baja sola, derecho a la raíz:" impactAccent="good" hitAt={2.5} boom={1} /> },
  { key: "b1_37", start: 361.04, dur: 9.96, kind: "chips", el: (d) => <ChipsCluster durationInFrames={d} bg="image" image="img/botella_enterrada.png" title="Lo que conseguís" chips={["Cero evaporación","Cero desperdicio","Cero hojas mojadas"]} hue="amber" /> },
];
