...
export const CUES: Cue[] = [
  ...
  { key: "b1_02", start: 9.4, dur: 5.56, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/b1_planta_mustia.png" hue="cold" kicker="Hojas mustias, colgando" zoom={[1.05,1.18]} /> },
  { key: "b1_03", start: 14.96, dur: 3.6, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/b1_planta_doblada.png" hue="cold" kicker="Doblado sobre sí mismo" zoom={[1.04,1.16]} /> },
  ...
  { key: "b1_05", start: 25.88, dur: 8.22, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/b1_regadera.png" hue="amber" kicker="Regaste todos los días" zoom={[1.18,1.05]} /> },
  ...
  { key: "b1_10b", start: 60.56, dur: 6.1, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/b1_botellas_plastico.png" hue="blue" kicker="Con lo que tirás a la basura" zoom={[1.06,1.16]} /> },
  ...
  { key: "b1_12", start: 94.04, dur: 5.04, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/b1_manguera_riego.png" hue="amber" kicker="Mojás la tierra por arriba" zoom={[1.16,1.06]} /> },
  ...
  { key: "b1_16b", start: 121.78, dur: 9.04, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/b1_raices_superficie.png" hue="amber" kicker="Raíces que suben, no bajan" zoom={[1.04,1.14]} /> },
