...
export const CUES: Cue[] = [
  ...
  { key: "p4_22", start: 128.62, dur: 2.82, kind: "impact", el: (d) => <ImpactReveal durationInFrames={d} image="img/semillas_paquetes.png" impact="TE CONVIENE PODAR" setup="Una verdad incómoda" impactAccent="danger" hitAt={3} boom={1} /> },
  ...
  { key: "p4_26", start: 163.26, dur: 2.98, kind: "impact", el: (d) => <ImpactReveal durationInFrames={d} image="img/tomatera_grande.png" impact="ESTA SEMANA" setup="Esto es lo que quiero que hagas" impactAccent="good" hitAt={3} boom={1} /> },
