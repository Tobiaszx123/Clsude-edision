...
export const CUES: Cue[] = [
  ...
  { key: "p2_02", start: 14.42, dur: 7.86, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/ceniza_anillo.png" hue="amber" kicker="Ceniza: muralla contra babosas" /> },
  ...
  { key: "p2_04", start: 32.58, dur: 18.62, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/cascara_molida.png" hue="amber" kicker="Cáscara de huevo molida" /> },
  ...
  { key: "p2_06", start: 60.18, dur: 14.08, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/canela_plantines.png" hue="amber" kicker="Canela: contra el hongo de almácigos" /> },
  ...
  { key: "p2_08", start: 80.26, dur: 12.61, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/borra_cafe.png" hue="amber" kicker="Borra de café: las plagas se alejan" /> },
  ...
  { key: "p2_12", start: 112.59, dur: 5.78, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/mostrador_veneno.png" hue="red" kicker="Te ponen el frasco en la mano" /> },
  { key: "p2_13", start: 118.37, dur: 2.2, kind: "impact", el: (d) => <ImpactReveal durationInFrames={d} image="img/polvo_mar_pila.png" impact="no hay plata en lo que DURA" setup="La respuesta de siempre:" impactAccent="danger" hitAt={2.5} boom={2} /> },
  ...
  { key: "p2_18", start: 164.15, dur: 6.26, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/primer_anillo.png" hue="amber" kicker="Esta semana: tu primer anillo" /> },
  ...
  { key: "p2_20", start: 198.03, dur: 11.24, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="img/spray_natural.png" hue="blue" kicker="La próxima: spray natural casero" /> },
  ...
  { key: "p2_22", start: 212.97, dur: 2.2, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="img/huerta_sana_final.png" eyebrow="Cuidá tu mesa" words={parseQuote("Cuidá tu huerta sin envenenar tu mesa. Así lo hacían *los viejos*.")} accent="amber" hue="amber" fontSize={72} /> },
];
