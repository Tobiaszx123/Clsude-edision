// Main_polvo1.tsx — ventanas de avatar en ./av_polvo1.gen (generado), look webcam + cutaways del presentador.
import { AbsoluteFill, Sequence } from "remotion";
import { CUES } from "./cues_polvo1.gen";
import { sec, COLORS } from "./theme";
import { CinematicWrap } from "./components/CinematicWrap";
import { AvatarLayer } from "./scenes/AvatarLayer";
import { AV } from "./av_polvo1.gen";
...
export const MainPolvo1: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg0 }}>
      ...
      <AvatarLayer src="polvo1_opt.mp4" windows={AV} />
    </AbsoluteFill>
  );
};
