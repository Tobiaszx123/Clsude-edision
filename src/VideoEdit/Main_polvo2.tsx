// Main_polvo2.tsx — ventanas de avatar en ./av_polvo2.gen (generado), look webcam + cutaways del presentador.
import { AbsoluteFill, Sequence } from "remotion";
import { CUES } from "./cues_polvo2.gen";
import { sec, COLORS } from "./theme";
import { CinematicWrap } from "./components/CinematicWrap";
import { AvatarLayer } from "./scenes/AvatarLayer";
import { AV } from "./av_polvo2.gen";
...
export const MainPolvo2: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg0 }}>
      ...
      <AvatarLayer src="polvo2_opt.mp4" windows={AV} />
    </AbsoluteFill>
  );
};
