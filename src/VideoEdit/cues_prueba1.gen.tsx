...
export const CUES: Cue[] = [
  ...
  { key: "p03", start: 13.08, dur: 2.9, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_buscar_tomate.mp4" hue="cold" kicker="¿Y los tomates?" /> },
  ...
  { key: "p15", start: 73.02, dur: 9.54, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_planta_salvaje.mp4" hue="cold" kicker="Dejada a su aire" /> },
  { key: "p16", start: 82.56, dur: 7.4, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="vid/yt_brotes_laterales.mp4" hue="cold" kicker="100 ramitas que compiten" /> },
